...
@section('content')
    <div class="card">
        <div class="p-5 flex justify-between">
            <h6 class=" text-lg text-gray-500 font-semibold">Edit Data Masyarakat</h6>
        ...
        <div class="card-body">
            <form action="{{ route('masyarakat.editstore', $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <select name="jenis_kelamin" id="jeniskelamin"
                        ...
                        <option value="laki"
                            {{ old('jenis_kelamin', $user->jenis_kelamin) == 'laki' ? 'selected' : '' }}>Laki-laki</option>
