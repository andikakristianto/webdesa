...
@section('content')
    <div class="card mt-5 mb-5 bg-white shadow-md rounded-lg">
        <div class="card-title">
            <h2 class="text-2xl font-bold text-center py-4">Form Edit Pembuatan Akte</h2>
        </div>
        <div class="card-body p-6">
            <form action="{{ route('layananakte.updatestore', $akte->id) }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" id="nama"
                        ...
                        placeholder="Masukkan Nama Lengkap" value="{{ old('nama', $akte->nama) }}" required>
                    @error('nama')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="kk" id="kk"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        placeholder="Masukkan Nomor KK" value="{{ old('kk', $akte->kk) }}">
                    @error('kk')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nik" id="nik"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        placeholder="Masukkan NIK" value="{{ old('nik', $akte->nik) }}">
                    @error('nik')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="jeniskelamin" id="jeniskelamin"
                        ...
                        <option value="laki" {{ old('jeniskelamin', $akte->jeniskelamin) == 'laki' ? 'selected' : '' }}>
                            Laki-laki</option>
                        <option value="perempuan"
                            {{ old('jeniskelamin', $akte->jeniskelamin) == 'perempuan' ? 'selected' : '' }}>Perempuan
                        </option>
                    </select>
                    @error('jeniskelamin')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="tempatlahir" id="tempatlahir"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        placeholder="Masukkan Tempat Lahir" value="{{ old('tempatlahir', $akte->tempatlahir) }}" required>
                    @error('tempatlahir')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="agama" id="agama"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        placeholder="Masukkan Agama" value="{{ old('agama', $akte->agama) }}" required>
                    @error('agama')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="tanggallahir" id="tanggallahir"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        value="{{ old('tanggallahir', $akte->tanggallahir) }}" required>
                    @error('tanggallahir')
                        <p class="text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
