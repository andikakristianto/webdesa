...
@section('content')
    <div class="card mt-5 mb-5 bg-white shadow-md rounded-lg">
        <div class="card-title">
            <h2 class="text-2xl font-bold text-center py-4">Form Regist Pembuatan Kartu Keluarga</h2>
        </div>
        <div class="card-body p-6">
            <form action="{{ route('layanankk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="kepalakeluarga" id="kepalakeluarga"
                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0"
                        placeholder="Masukkan Nama Kepala Keluarga" value="{{ old('kepalakeluarga') }}" required>
